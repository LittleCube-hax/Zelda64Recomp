...
void EnTest6_DoubleSoTCutscene(EnTest6* this, PlayState* play) {
    ...
    s16* sDoubleSoTCsFogNear_ptr = &sDoubleSoTCsFogNear;
    s16* sDoubleSoTCsZFar_ptr = &sDoubleSoTCsZFar;

    Color_RGB8* sDoubleSoTCsFogColor_ptr = &sDoubleSoTCsFogColor;
    Color_RGB8* sDoubleSoTCsAmbientColor_ptr = &sDoubleSoTCsAmbientColor;
    Color_RGB8* sDoubleSoTCsDiffuseColor_ptr = &sDoubleSoTCsDiffuseColor;
